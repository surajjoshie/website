...
### **नीतियाँ (Policies)**
आप कुबेरनेट्स-नेटिव तंत्रों का उपयोग करके सुरक्षा नीतियां परिभाषित कर सकते हैं, जैसे कि **NetworkPolicy** (नेटवर्क पैकेट फ़िल्टरिंग पर घोषणात्मक नियंत्रण) या **ValidatingAdmissionPolicy** (कुबेरनेट्स API का उपयोग करके कोई क्या परिवर्तन कर सकता है, इस पर घोषणात्मक प्रतिबंध)।

हालाँकि, आप कुबेरनेट्स के आसपास के व्यापक इकोसिस्टम से नीति कार्यान्वयन पर भी भरोसा कर सकते हैं। कुबेरनेट्स उन इकोसिस्टम प्रोजेक्ट्स को सोर्स कोड समीक्षा, कंटेनर इमेज अनुमोदन, API एक्सेस कंट्रोल, नेटवर्किंग और बहुत कुछ पर अपने स्वयं के नीति नियंत्रण लागू करने देने के लिए एक्सटेंशन तंत्र प्रदान करता है।
...
* कुबेरनेट्स में ज्ञात कमजोरियां (Known vulnerabilities in Kubernetes)
* कंट्रोल प्लेन के लिए ट्रांजिट में डेटा एन्क्रिप्शन
* एट-रेस्ट डेटा एन्क्रिप्शन
* कुबेरनेट्स API तक पहुंच को नियंत्रित करना
* पॉड्स के लिए नेटवर्क नीतियां
...
* पॉड सुरक्षा मानक (Pod Security Standards)
* पॉड सुरक्षा प्रवेश (Pod Security Admission)
* सर्विस अकाउंट्स (Service Accounts)
* पॉड सुरक्षा नीतियां (Pod Security Policies)
* लिनक्स नोड्स के लिए सुरक्षा
* विंडोज नोड्स के लिए सुरक्षा
* कुबेरनेट्स API तक पहुंच को नियंत्रित करना
* रोल बेस्ड एक्सेस कंट्रोल (RBAC) अच्छी प्रथाएं
* कुबेरनेट्स सीक्रेट्स के लिए अच्छी प्रथाएं
* मल्टी-टेनेंसी (Multi-tenancy)
* हार्डनिंग गाइड - प्रमाणीकरण तंत्र (Authentication Mechanisms)
* हार्डनिंग गाइड - शेड्यूलर कॉन्फ़िगरेशन
* कुबेरनेट्स API सर्वर बाईपास जोखिम
* पॉड्स और कंटेनरों के लिए लिनक्स कर्नेल सुरक्षा बाधाएं
* सुरक्षा चेकलिस्ट (Security Checklist)
* एप्लीकेशन सुरक्षा चेकलिस्ट
